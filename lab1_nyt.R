library(class)
nyt1<-read.csv("C:/Users/fragaj3/Dropbox/Spring2024/CSCI_4600_01_Data_Analytics/Lab/Lab03/nyt1.csv")
...
classif <- knn(train, test, cg, k = 5) # Now you can use the knn function
classif
